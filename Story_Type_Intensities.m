function [story_type1_all, story_type2_all, story_type3_all, story_type4_all] = Story_Type_Intensities(surveyData, k)
...
%             survey=survey3800;
    ...
    %each survey
    s1i=cell(3,2),s2i=cell(3,1),s3i=cell(3,1),s4i=cell(2,1),s5i=cell(2,1),s6i=cell(3,1),s7i=cell(2,1),s8i=cell(3,1),s9i=cell(2,1),s10i=cell(2,1),s11i=cell(3,1),s12i=cell(1,1); %list of intensities
    ...
    for s=1:1:12
        ...
        for i=1:1:rows
            ...
            if s==1
                ...
                %storing intensities in intensityData Matrix
...
%                         story_type1_a(isurvey,1:length(story_type1_all)) = story_type1_all;
                    ...
                    story_type2_a(1,1:length(story_type2_all)) = story_type2_all;
...
%         story_type1_a(k,1:length(story_type1_all)) = story_type1_all;
...
% story_type1_a(k,1:length(story_type1_all)) = story_type1_all;
% [h,p,ci,stats]=ttest2(story_type2_all,story_type3_all)
% 
% 
% 
% 
